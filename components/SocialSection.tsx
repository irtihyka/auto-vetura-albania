...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="40" width="40" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex justify-center space-x-12">
          {socialLinks.map((social) => (
            <a
              key={social.name}
              target="_blank"
              className={`transition transform hover:scale-110 drop-shadow-lg ${social.colorClass}`}
              href={social.href}
