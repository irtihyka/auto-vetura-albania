...
export default function AboutPage() {
  return (
    <main className="bg-gradient-to-r from-gray-100 to-gray-200 w-full text-gray-900 flex-grow flex flex-col items-center">
      {/* Hero */}
      <section className="relative text-white pt-28 pb-20 bg-gradient-to-r from-blue-500 to-cyan-500 shadow-lg w-full">
        <div className="container mx-auto text-center px-4">
          ...
          <a
            className="inline-block bg-white text-blue-600 font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-gray-100 transition transform hover:scale-105"
            href="#more-info"
          >
            Mëso më shumë
          </a>
      ...
      <section className="py-16 w-full">
        <div className="container mx-auto text-center px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            >
              <div className="w-20 h-20 flex items-center justify-center bg-gradient-to-br from-blue-500 to-cyan-500 text-white rounded-full mb-6 shadow-lg group-hover:scale-110 transition-transform">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/contact"
                className="inline-block bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition transform hover:scale-105 mt-4"
              >
                Na kontaktoni
              </Link>
            </div>
            <div className="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-lg p-12 flex items-center justify-center">
              <svg
